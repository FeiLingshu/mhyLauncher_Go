...
namespace EfficiencyMode
{
    ...
    public static class VersionHelper
    {
        ...
        public static string WinReleaseId
        {
            get
            {
                if (TryGetRegistryKey(@"SOFTWARE\Microsoft\Windows NT\CurrentVersion", "ReleaseId", out var releaseId))
                {
                    return releaseId;
                }
                return string.Empty;
        ...
        public static int WinCurrentBuild
        {
            get
            {
                ...
                {
                    if (int.TryParse(currentBuild, out int currentBuild_int))
                    {
                ...
                {
                    if (int.TryParse(currentBuildNumber, out int currentBuildNumber_int))
                    {
