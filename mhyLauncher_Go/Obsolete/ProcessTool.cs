...
namespace MHYLAUNCHER_GO.Obsolete
{
    ...
    public class ProcessTool
    {
        ...
        public struct Conditions
        {
            ...
            /// 响应函数应触发的方法体
            /// </summary>
            public Action<Process, string[]> _void;
            ...
            public Conditions(string name, string path, string[] args, Action<Process, string[]> _void)
            {
                this.name = name;
                this.path = path;
                this.args = args;
        ...
        public ProcessTool(Conditions infos)
        {
            this.infos = infos;
            StartProcessTool();
        }
