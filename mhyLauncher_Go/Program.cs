    ...
    internal static class Program
    {
        ...
        internal static void MainFunction_A(Process game, string[] args)
        {
            ...
            if (args.Length == 1)
            {
                ...
                if (iscustomsize)
                {
                    ...
                    int maxheight = workingareasize.Height - size_e.Height;
                ...
                if (iscustomsize)
                {
                    ...
                    lction_p.Offset(new Point()
                    {
                        ...
                        Y = workingareasize.Height - windowsize.Height - size_e.Height - (int)((workingareasize.Height - windowsize.Height - size_e.Height) * ((double)ints.Min() / ints.Sum())) + heightoffset
                    });
                }
                else
                {
                ...
                RECT rect = new RECT()
                {
                    ...
                    bottom = lction_p.Y + windowsize.Height + size_e.Height - heightoffset
                };
        ...
        internal static void MainFunction_B(Process game, string[] args)
        {
            ...
            if (args.Length == 1)
            {
                ...
                if (iscustomsize)
                {
                    int maxwidth = workingareasize.Width - size_e.Width * 2;
                    int maxheight = workingareasize.Height - size_e.Height - size_e.Width;
                    if (targatesize.Width > maxwidth)
                    {
                        windowsize.Width = maxwidth;
                    }
                ...
                if (iscustomsize)
                {
                    ...
                    {
                        X = (workingareasize.Width - windowsize.Width - size_e.Width) / 2,
                        Y = workingareasize.Height - windowsize.Height - size_e.Height - (int)((workingareasize.Height - windowsize.Height - size_e.Height) * ((double)ints.Min() / ints.Sum()))
                    });
                }
                else
                {
